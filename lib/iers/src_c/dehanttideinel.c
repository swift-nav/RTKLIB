...
/* Subroutine */ int dehanttideinel_(doublereal *xsta, integer *yr,
                                     integer *month, integer *day,
                                     doublereal *fhr, doublereal *xsun,
                                     doublereal *xmon, doublereal *dxtide) {
  /* Initialized data */
  ...
  extern /* Subroutine */ int step2diu_(doublereal *, doublereal *,
      ...
      step2lon_(doublereal *, doublereal *, doublereal *);
  static integer i__;
  ...
  static doublereal rsta, rmon, rsun, p2mon, p3mon, x2mon, x3mon, p2sun, p3sun,
      x2sun, x3sun, scmon;
  ...
  extern /* Subroutine */ int st1idiu_(doublereal *, doublereal *, doublereal *,
                                       doublereal *, doublereal *,
                                       doublereal *);
  static doublereal mass_ratio_sun__;
  extern /* Subroutine */ int st1isem_(doublereal *, doublereal *, doublereal *,
                                       doublereal *, doublereal *,
                                       doublereal *);
  ...
  /*  Called: */
  /*     SPROD             Finds the scalar product and unit vector of two
   * vectors */
  ...
  d__1 = scsun;
  p3sun =
      (h3 - l3 * 3.) * 2.5 * (d__1 * (d__1 * d__1)) + (l3 - h3) * 1.5 * scsun;
  /* Computing 3rd power */
  d__1 = scmon;
  p3mon =
      (h3 - l3 * 3.) * 2.5 * (d__1 * (d__1 * d__1)) + (l3 - h3) * 1.5 * scmon;
  /* ---------------------------------------------------------------------- */
  ...
  for (i__ = 1; i__ <= 3; ++i__) {
    dxtide[i__] =
        fac2sun * (x2sun * xsun[i__] / rsun + p2sun * xsta[i__] / rsta) +
        fac2mon * (x2mon * xmon[i__] / rmon + p2mon * xsta[i__] / rsta) +
        fac3sun * (x3sun * xsun[i__] / rsun + p3sun * xsta[i__] / rsta) +
        fac3mon * (x3mon * xmon[i__] / rmon + p3mon * xsta[i__] / rsta);
    /* L10: */
  }
  zero_vec8__(xcorsta);
  /* +--------------------------------------------------------------------- */
