...
/* Subroutine */ int st1l1_(doublereal *xsta, doublereal *xsun,
                            doublereal *xmon, doublereal *fac2sun,
                            doublereal *fac2mon, doublereal *xcorsta) {
  /* Initialized data */
  ...
  static doublereal cosla, demon, sinla, dnmon, desun, dnsun, cosphi, sinphi;
  ...
  /* Computing 2nd power */
  d__2 = rsun;
  dnsun = -l1 * (d__1 * d__1) * *fac2sun * xsun[3] *
          (xsun[1] * cosla + xsun[2] * sinla) / (d__2 * d__2);
  /* Computing 2nd power */
  d__1 = sinphi;
  /* Computing 2nd power */
  d__2 = rmon;
  dnmon = -l1 * (d__1 * d__1) * *fac2mon * xmon[3] *
          (xmon[1] * cosla + xmon[2] * sinla) / (d__2 * d__2);
  /* Computing 2nd power */
  d__1 = cosphi;
  /* Computing 2nd power */
  d__2 = sinphi;
  ...
  dnsun = -l1 / 2. * sinphi * cosphi * *fac2sun *
          ((d__1 * d__1 - d__2 * d__2) * costwola +
           xsun[1] * 2. * xsun[2] * sintwola) /
          (d__3 * d__3);
  /* Computing 2nd power */
  d__1 = xmon[1];
  /* Computing 2nd power */
  ...
  /* Computing 2nd power */
  d__4 = rsun;
  desun = -l1 / 2. * (d__1 * d__1) * cosphi * *fac2sun *
          ((d__2 * d__2 - d__3 * d__3) * sintwola -
           xsun[1] * 2. * xsun[2] * costwola) /
          (d__4 * d__4);
  /* Computing 2nd power */
  d__1 = sinphi;
  /* Computing 2nd power */
  ...
  /* Computing 2nd power */
  d__4 = rmon;
  demon = -l1 / 2. * (d__1 * d__1) * cosphi * *fac2mon *
          ((d__2 * d__2 - d__3 * d__3) * sintwola -
           xmon[1] * 2. * xmon[2] * costwola) /
          (d__4 * d__4);
  de = (desun + demon) * 3.;
  dn = (dnsun + dnmon) * 3.;
