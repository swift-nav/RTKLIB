...
/* Subroutine */ int st1idiu_(doublereal *xsta, doublereal *xsun,
  ...
  /* Computing 2nd power */
  d__1 = rsun;
  drsun = dhi * -3. * sinphi * cosphi * *fac2sun * xsun[3] *
          (xsun[1] * sinla - xsun[2] * cosla) / (d__1 * d__1);
  /* Computing 2nd power */
  d__1 = rmon;
  drmon = dhi * -3. * sinphi * cosphi * *fac2mon * xmon[3] *
          (xmon[1] * sinla - xmon[2] * cosla) / (d__1 * d__1);
  /* Computing 2nd power */
  d__1 = rsun;
  dnsun = dli * -3. * cos2phi * *fac2sun * xsun[3] *
          (xsun[1] * sinla - xsun[2] * cosla) / (d__1 * d__1);
  /* Computing 2nd power */
  d__1 = rmon;
  dnmon = dli * -3. * cos2phi * *fac2mon * xmon[3] *
          (xmon[1] * sinla - xmon[2] * cosla) / (d__1 * d__1);
  /* Computing 2nd power */
  d__1 = rsun;
  desun = dli * -3. * sinphi * *fac2sun * xsun[3] *
          (xsun[1] * cosla + xsun[2] * sinla) / (d__1 * d__1);
  /* Computing 2nd power */
  d__1 = rmon;
  demon = dli * -3. * sinphi * *fac2mon * xmon[3] *
          (xmon[1] * cosla + xmon[2] * sinla) / (d__1 * d__1);
  dr = drsun + drmon;
  dn = dnsun + dnmon;
  de = desun + demon;
