...
/* Subroutine */ int vmf1_ht__(doublereal *ah, doublereal *aw, doublereal *dmjd,
                               doublereal *dlat, doublereal *ht, doublereal *zd,
                               doublereal *vmf1h, doublereal *vmf1w) {
  /* Builtin functions */
  double cos(doublereal), sin(doublereal);

  /* Local variables */
  static doublereal bh, ch, bw, cw, c0h, c10h, c11h, phh, doy, beta, a_ht__,
      b_ht__, c_ht__, sine, ht_corr_coef__, gamma, hs_km__, topcon, ht_corr__;
  ...
  /*  This subroutine determines the Vienna Mapping Function 1 (VMF1) (Boehm et
   * al. 2006). */
