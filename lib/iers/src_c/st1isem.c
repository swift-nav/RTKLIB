...
/* Subroutine */ int st1isem_(doublereal *xsta, doublereal *xsun,
  ...
  /* Computing 2nd power */
  d__4 = rsun;
  drsun = dhi * -.75 * (d__1 * d__1) * *fac2sun *
  ...
  /* Computing 2nd power */
  d__4 = rmon;
  drmon = dhi * -.75 * (d__1 * d__1) * *fac2mon *
          ((d__2 * d__2 - d__3 * d__3) * sintwola -
  ...
  /* Computing 2nd power */
  d__3 = rsun;
  dnsun = dli * 1.5 * sinphi * cosphi * *fac2sun *
          ((d__1 * d__1 - d__2 * d__2) * sintwola -
           xsun[1] * 2. * xsun[2] * costwola) /
          (d__3 * d__3);
  /* Computing 2nd power */
  d__1 = xmon[1];
  ...
  /* Computing 2nd power */
  d__3 = rmon;
  dnmon = dli * 1.5 * sinphi * cosphi * *fac2mon *
          ((d__1 * d__1 - d__2 * d__2) * sintwola -
           xmon[1] * 2. * xmon[2] * costwola) /
          (d__3 * d__3);
  /* Computing 2nd power */
