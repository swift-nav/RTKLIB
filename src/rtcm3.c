...
static int decode_head1001(rtcm_t *rtcm, int *sync) {
  ...
  trace(4,
        "decode_head1001: time=%s nsat=%d sync=%d\n",
...
static int decode_head1009(rtcm_t *rtcm, int *sync) {
  ...
  trace(4,
        "decode_head1009: time=%s nsat=%d sync=%d\n",
        time_str(rtcm->time, 2),
        nsat,
        *sync);
...
/* decode type 1042: Beidou ephemerides (ref [15]) -------------------*/
static int decode_type1042(rtcm_t *rtcm) {
  eph_t eph = {0};
  double toc = 0.0, sqrtA = 0.0;
  char *msg;
  int i = 24 + 12;
  int prn, sat, week, sys = SYS_CMP;
...
static int decode_type1047(rtcm_t *rtcm) {
  ...
  trace(
      4, "decode_type1047: prn=%d iode=%d toe=%.0f\n", prn, eph.iode, eph.toes);
...
static int decode_ssr2_head(
    rtcm_t *rtcm, int sys, int *sync, int *iod, double *udint, int *hsize) {
  double tod, tow;
  char *msg;
  int i = 24 + 12, nsat, udi, provid = 0, solid = 0, ns = 6;
...
static const int codes_gps[] = {CODE_L1C,
                                CODE_L1P,
                                CODE_L1W,
                                CODE_L1Y,
                                CODE_L1M,
...
static const int codes_gal[] = {CODE_L1A,
                                CODE_L1B,
                                CODE_L1C,
                                CODE_L1X,
                                CODE_L1Z,
                                ...
                                CODE_L6X,
                                CODE_L6Z};
static const int codes_qzs[] = {CODE_L1C,
                                CODE_L1S,
                                CODE_L1L,
                                CODE_L2S,
                                CODE_L2L,
                                ...
                                CODE_L6X,
                                CODE_L1X};
static const int codes_bds[] = {CODE_L1I,
                                CODE_L1Q,
                                CODE_L1X,
                                CODE_L7I,
                                CODE_L7Q,
...
static int decode_ssr7(rtcm_t *rtcm, int sys) {
  ...
  if ((nsat = decode_ssr7_head(
           rtcm, sys, &sync, &iod, &udint, &dispe, &mw, &i)) < 0) {
    trace(2, "rtcm3 %d length error: len=%d\n", type, rtcm->len);
    return -1;
  }
  switch (sys) {
