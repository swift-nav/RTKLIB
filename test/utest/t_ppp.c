...
void utest2(void) {
  ...
  double rs[] = {70842740307.0837, 115293403265.153,
                 -57704700666.9715}; /* de405 */
  ...
  printf("X_moon=%15.0f %15.0f %7.4f\n", rmoon[0], rm[0],
         (rmoon[0] - rm[0]) / rmoon[0]);
  printf("Y_moon=%15.0f %15.0f %7.4f\n", rmoon[1], rm[1],
         (rmoon[1] - rm[1]) / rmoon[1]);
  printf("Z_moon=%15.0f %15.0f %7.4f\n", rmoon[2], rm[2],
         (rmoon[2] - rm[2]) / rmoon[2]);
