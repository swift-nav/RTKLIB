...
private:
  ...
  void DrawVertGraph(QPainter &c, const double *sol, const int *stat, int psol,
                     int psols, int psole, int nsol, int currentstat);
  QPoint PosToPoint(const double *pos);
  QPoint PosToGraphP(const double *pos, const double *ref, int index, int npos,
                     QRect rect);
  ...
  void DrawGrid(QPainter &c, QPoint p, int gint, int ng, QColor color1,
                QColor color2);
...
public:
  ...
  void ResetRef(void);
  void UpdateMap(const double *sol, const double *solref, const double *vel,
                 const int *stat, int psol, int psols, int psole, int nsol,
                 QString *solstr, int currentstat);
