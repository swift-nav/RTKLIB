...
MonitorDialog::MonitorDialog(QWidget *parent) : QDialog(parent) {
  ...
  connect(SelFmt, SIGNAL(currentIndexChanged(int)), this,
          SLOT(SelFmtChange(int)));
  connect(SelObs, SIGNAL(currentIndexChanged(int)), this,
          SLOT(SelObsChange(int)));
...
void MonitorDialog::ClearTable(void) {
  ...
  SelSat->setVisible((2 <= TypeF && TypeF <= 7) ||
                     (10 <= TypeF && TypeF <= 15));
...
void MonitorDialog::ShowRtk(void) {
  ...
  QString mode[] = {tr("Single"),        tr("DGPS"),        tr("Kinematic"),
  ...
  char file[1024] = "";
  QString ionoopt[] = {tr("OFF"),           tr("Broadcast"),
                       tr("SBAS"),          tr("Dual-Frequency"),
                       tr("Estimate STEC"), tr("IONEX TEC"),
                       tr("QZSS LEX"),      ""};
  QString tropopt[] = {tr("OFF"),          tr("Saastamoinen"),      tr("SBAS"),
                       tr("Estimate ZTD"), tr("Estimate ZTD+Grad"), ""};
  QString ephopt[] = {tr("Broadcast"),
                      tr("Precise"),
                      tr("Broadcast+SBAS"),
                      tr("Broadcat+SSR APC"),
  ...
  for (j = k = 0; j < MAXSAT; j++) {
    if (rtk.opt.mode == PMODE_SINGLE && !rtk.ssat[j].vs)
      continue;
    if (rtk.opt.mode != PMODE_SINGLE && !rtk.ssat[j].vsat[0])
      continue;
  ...
  if (rtk.opt.navsys & SYS_GPS)
    navsys = navsys + tr("GPS ");
  if (rtk.opt.navsys & SYS_GLO)
    navsys = navsys + tr("GLONASS ");
  if (rtk.opt.navsys & SYS_GAL)
    navsys = navsys + tr("Galileo ");
  if (rtk.opt.navsys & SYS_QZS)
    navsys = navsys + tr("QZSS ");
  if (rtk.opt.navsys & SYS_SBS)
    navsys = navsys + tr("SBAS ");
  if (rtk.opt.navsys & SYS_CMP)
    navsys = navsys + tr("BeiDou ");
  if (rtk.opt.navsys & SYS_IRN)
    navsys = navsys + tr("IRNSS ");

  Label->setText("");
  if (Console->rowCount() < 56)
    return;
  Console->setHorizontalHeaderLabels(header);
  ...
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(QString::number(rtk.opt.elmin * R2D, 'f', 0)));
  ...
  Console->setItem(
      i, 0, new QTableWidgetItem(tr("Rec Dynamic/Earth Tides Correction")));
  Console->setItem(
      i++, 1,
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("Ionosphere/Troposphere Model")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2")
                                            .arg(ionoopt[rtk.opt.ionoopt])
                                            .arg(tropopt[rtk.opt.tropopt])));
  ...
  for (j = 1; j <= MAXSAT; j++) {
    if (!rtk.opt.exsats[j - 1])
      continue;
    satno2id(j, id);
    if (rtk.opt.exsats[j - 1] == 2)
      exsats = exsats + "+";
    exsats = exsats + id + " ";
  }
  ...
  Console->setItem(
      i, 0, new QTableWidgetItem(tr("CPU Time for a Processing Cycle (ms)")));
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(
                       QString("%1,%2,%3").arg(nb[0]).arg(nb[1]).arg(nb[2])));

  Console->setItem(i, 0, new QTableWidgetItem(tr("# of Input Data Rover")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(
                       QString(tr("Obs(%1),Nav(%2),Gnav(%3),Ion(%4),Sbs(%5),"
                                  "Pos(%6),Dgps(%7),Ssr(%8),Lex(%9),Err(%10)"))
                           .arg(nmsg[0][0])
                           .arg(nmsg[0][1])
                           .arg(nmsg[0][6])
                           .arg(nmsg[0][2])
  ...
  Console->setItem(
      i, 0, new QTableWidgetItem(tr("# of Input Data Base/NRTK Station")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(
                       QString(tr("Obs(%1),Nav(%2),Gnav(%3),Ion(%4),Sbs(%5),"
                                  "Pos(%6),Dgps(%7),Ssr(%8),Lex(%9),Err(%10)"))
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("Time of Receiver Clock Rover")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(rtk.sol.time.time ? tstr : "-"));

  Console->setItem(
      i, 0,
      new QTableWidgetItem(tr("Time Sytem Offset/Receiver Bias "
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString::number(rtk.tt, 'f', 3)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Age of Differential (s)")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString::number(rtk.sol.age, 'f', 3)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Ratio for AR Validation")));
  Console->setItem(
      i++, 1, new QTableWidgetItem(QString::number(rtk.sol.ratio, 'f', 3)));
  ...
  Console->setItem(
      i, 0, new QTableWidgetItem(tr("# of Satellites Base/NRTK Station")));
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("# of Real Estimated States")));
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("Pos X/Y/Z Single (m) Rover")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
  ...
  Console->setItem(
      i, 0, new QTableWidgetItem(tr("Lat/Lon/Height Single (deg,m) Rover")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(pos[0] * R2D, 0, 'f', 8)
                                            .arg(pos[1] * R2D, 0, 'f', 8)
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("Pos X/Y/Z Float Std (m) Rover")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(
          QString("%1,%2,%3")
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("Pos X/Y/Z Fixed Std (m) Rover")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(
          QString("%1,%2,%3")
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("Pos X/Y/Z (m) Base/NRTK Station")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(rtk.rb[0], 0, 'f', 3)
                                            .arg(rtk.rb[1], 0, 'f', 3)
  ...
  Console->setItem(
      i, 0,
      new QTableWidgetItem(tr("Lat/Lon/Height (deg,m) Base/NRTK Station")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(pos[0] * R2D, 0, 'f', 8)
                                            .arg(pos[1] * R2D, 0, 'f', 8)
  ...
  Console->setItem(
      i, 0, new QTableWidgetItem(tr("Vel E/N/U (m/s) Base/NRTK Station")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(vel[0], 0, 'f', 3)
                                            .arg(vel[1], 0, 'f', 3)
  ...
  Console->setItem(
      i, 0,
      new QTableWidgetItem(tr("# of Averaging Single Pos Base/NRTK Station")));
  ...
  Console->setItem(
      i, 0, new QTableWidgetItem(tr("Ant Phase Center L1 E/N/U (m) Rover")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(off1[0], 0, 'f', 3)
                                            .arg(off1[1], 0, 'f', 3)
  ...
  Console->setItem(
      i, 0, new QTableWidgetItem(tr("Ant Phase Center L2 E/N/U (m) Rover")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(off2[0], 0, 'f', 3)
                                            .arg(off2[1], 0, 'f', 3)
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("Antenna Type Base/NRTK Station")));
  Console->setItem(i++, 1, new QTableWidgetItem(rtk.opt.pcvr[1].type));

  off1 = rtk.opt.pcvr[1].off[0];
  Console->setItem(i, 0,
                   new QTableWidgetItem(
                       tr("Ant Phase Center L1 E/N/U (m) Base/NRTK Station")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(off1[0], 0, 'f', 3)
                                            .arg(off1[1], 0, 'f', 3)
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(
                       tr("Ant Phase Center L2 E/N/U (m) Base/NRTK Station")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(off2[0], 0, 'f', 3)
                                            .arg(off2[1], 0, 'f', 3)
  ...
  Console->setItem(
      i, 0, new QTableWidgetItem(tr("Ant Delta E/N/U (m) Base/NRTK Station")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(del[0], 0, 'f', 3)
                                            .arg(del[1], 0, 'f', 3)
  ...
  Console->setItem(
      i, 0, new QTableWidgetItem(tr("Precise Ephemeris Time/# of Epoch")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(QString("%1-%2 (%3)").arg(s1).arg(s2).arg(ne)));

  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("Precise Ephemeris Download Time")));
  Console->setItem(i++, 1, new QTableWidgetItem(s3));

  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("Precise Ephemeris Download File")));
  Console->setItem(i++, 1, new QTableWidgetItem(file));
}
//---------------------------------------------------------------------------
void MonitorDialog::SetSat(void) {
  int i, j = 0, freq[] = {1, 2, 5, 6, 7, 8};
  QString label[] = {tr("SAT"),
                     tr("PRN"),
                     tr("Status"),
                     tr("Azimuth (deg)"),
                     tr("Elevation (deg)"),
...
void MonitorDialog::ShowSat(int sys) {
  ...
  for (i = 0, n = 1; i < MAXSAT; i++) {
    if (!(satsys(i + 1, NULL) & sys))
      continue;
    ssat = rtk.ssat + i;
    if (SelSat->currentIndex() == 1 && !ssat->vs)
      continue;
    n++;
  }
  ...
  for (i = 0, n = 0; i < MAXSAT; i++) {
    ...
    Console->setItem(n, j++,
                     new QTableWidgetItem(ssat->vs ? tr("OK") : tr("-")));
    az = ssat->azel[0] * R2D;
    if (az < 0.0)
      az += 360.0;
    el = ssat->azel[1] * R2D;
    ...
    for (k = 0; k < NFREQ; k++) {
      Console->setItem(
          n, j++, new QTableWidgetItem(ssat->vsat[k] ? tr("OK") : tr("-")));
    }
    for (k = 0; k < NFREQ; k++) {
      fix = ssat->fix[k];
      Console->setItem(
    ...
    for (k = 0; k < NFREQ; k++) {
      Console->setItem(
          n, j++, new QTableWidgetItem(QString::number(ssat->resp[k], 'f', 2)));
    }
    for (k = 0; k < NFREQ; k++) {
      Console->setItem(
          n, j++, new QTableWidgetItem(QString::number(ssat->resc[k], 'f', 4)));
    }
    for (k = 0; k < NFREQ; k++) {
      Console->setItem(n, j++,
                       new QTableWidgetItem(QString::number(ssat->slipc[k])));
    }
    for (k = 0; k < NFREQ; k++) {
      Console->setItem(n, j++,
                       new QTableWidgetItem(QString::number(ssat->lock[k])));
    }
    for (k = 0; k < NFREQ; k++) {
      Console->setItem(n, j++,
                       new QTableWidgetItem(QString::number(ssat->outc[k])));
    }
    for (k = 0; k < NFREQ; k++) {
      Console->setItem(n, j++,
                       new QTableWidgetItem(QString::number(ssat->rejc[k])));
    }
    for (k = 0; k < NFREQ; k++) {
      Console->setItem(
          n, j++,
          new QTableWidgetItem(QString("%1").arg(lam[i][k], 7, 'f', 5)));
    }
    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(ssat->gf, 'f', 3)));
    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(ssat->phw, 'f', 2)));
    Console->setItem(
        n, j++, new QTableWidgetItem(QString::number(cbias[i][0], 'f', 2)));
    Console->setItem(
        n, j++, new QTableWidgetItem(QString::number(cbias[i][1], 'f', 2)));
    Console->setItem(
        n, j++, new QTableWidgetItem(QString::number(cbias[i][2], 'f', 2)));
    n++;
  }
}
//---------------------------------------------------------------------------
void MonitorDialog::SetEst(void) {
  QString label[] = {tr("State"), tr("Estimate Float"), tr("Std Float"),
                     tr("Estimate Fixed"), tr("Std Fixed")};
...
void MonitorDialog::ShowEst(void) {
  ...
  for (i = 0, n = 0; i < nx; i++) {
    if (SelSat->currentIndex() == 1 && x[i] == 0.0)
      continue;
    n++;
  }
  if (n < 2) {
  ...
  for (i = 0, n = 1; i < nx; i++) {
    ...
    if (SelSat->currentIndex() == 1 && x[i] == 0.0)
      continue;
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString(tr("X_%1")).arg(i + 1)));
    Console->setItem(
        i, j++,
    ...
    Console->setItem(i, j++,
                     new QTableWidgetItem(
                         P[i + i * nx] == 0.0
                             ? s0
                             : QString::number(SQRT(P[i + i * nx]), 'f', 3)));
    Console->setItem(
        i, j++,
...
void MonitorDialog::ShowCov(void) {
  ...
  for (i = 0, n = 0; i < nx; i++) {
    if (SelSat->currentIndex() == 1 && (x[i] == 0.0 || P[i + i * nx] == 0.0))
      continue;
    n++;
  }
  if (n < 1) {
  ...
  for (i = 0, n = 0; i < nx; i++) {
    ...
    Console->setHorizontalHeaderItem(
        n, new QTableWidgetItem(QString(tr("X_%1")).arg(i + 1)));
    Console->setVerticalHeaderItem(
        n, new QTableWidgetItem(QString(tr("X_%1")).arg(i + 1)));
    for (j = 0, m = 0; j < nx; j++) {
      if (SelSat->currentIndex() == 1 && (x[j] == 0.0 || P[j + j * nx] == 0.0))
        continue;
      Console->setItem(n, m,
                       new QTableWidgetItem(
                           P[i + j * nx] == 0.0
...
void MonitorDialog::SetObs(void) {
  ...
  for (i = 0; i < NFREQ + nex; i++) {
    Console->setColumnWidth(j++, 30 * FontScale / 96);
    header << (i < NFREQ ? QString(tr("C%1")).arg(freq[i])
                         : QString(tr("CX%1")).arg(i - NFREQ + 1));
  }
  Console->setHorizontalHeaderLabels(header);
}
//---------------------------------------------------------------------------
void MonitorDialog::ShowObs(void) {
  ...
  for (i = 0; i < n; i++) {
    ...
    for (k = 0; k < NFREQ + nex; k++) {
      Console->setItem(
          i, j++, new QTableWidgetItem(QString::number(obs[i].P[k], 'f', 3)));
    }
    for (k = 0; k < NFREQ + nex; k++) {
      Console->setItem(
          i, j++, new QTableWidgetItem(QString::number(obs[i].L[k], 'f', 3)));
    }
    for (k = 0; k < NFREQ + nex; k++) {
      Console->setItem(
          i, j++, new QTableWidgetItem(QString::number(obs[i].D[k], 'f', 3)));
    }
    for (k = 0; k < NFREQ + nex; k++) {
      Console->setItem(
          i, j++,
          new QTableWidgetItem(QString::number(obs[i].SNR[k] * 0.25, 'f', 1)));
    }
    for (k = 0; k < NFREQ + nex; k++) {
      Console->setItem(i, j++,
                       new QTableWidgetItem(QString::number(obs[i].LLI[k])));
    }
    for (k = 0; k < NFREQ + nex; k++) {
      code = code2obs(obs[i].code[k], NULL);
      if (*code)
        Console->setItem(i, j++,
                         new QTableWidgetItem(QString(tr("L%1")).arg(code)));
      else
...
void MonitorDialog::SetNav(void) {
  header.clear();
  header << tr("SAT") << tr("PRN") << tr("Status") << tr("IODE") << tr("IODC")
         << tr("Accuracy") << tr("Health") << tr("Toe") << tr("Toc")
         << tr("Ttrans") << tr("A (m)") << tr("e") << tr("i0 (deg)")
         << tr("OMEGA0 (deg)") << tr("omega (deg)") << tr("M0 (deg)")
         << tr("deltan (deg/s)") << tr("OMEGAdot (deg/s)") << tr("IDOT (deg/s)")
         << tr("af0 (ns)") << tr("af1 (ns/s)") << tr("af2 (ns/s2)")
         << tr("TGD (ns)") << tr("BGD5a(ns)") << tr("BGD5b(ns)")
         << tr("Cuc(rad)") << tr("Cus(rad)") << tr("Crc(m)") << tr("Crs(m)")
         << tr("Cic(rad)") << tr("Cis(rad)") << tr("Code") << tr("Flag");
  int i, width[] = {25, 25, 30, 30, 30, 25, 25, 115, 115, 115, 80,
                    70, 60, 60, 60, 60, 70, 70, 70,  60,  50,  50,
                    50, 50, 50, 70, 70, 70, 70, 70,  70,  30,  30};
...
void MonitorDialog::ShowNav(int sys) {
  ...
  for (k = 0, n = 1; k < MAXSAT; k++) {
    if (!(satsys(k + 1, &prn) & sys))
      continue;
    valid = eph[k].toe.time != 0 && !eph[k].svh &&
            fabs(timediff(time, eph[k].toe)) <= MAXDTOE;
    if (SelSat->currentIndex() == 1 && !valid)
      continue;
    n++;
  }
  if (n < 2) {
  ...
  for (k = 0, n = 0; k < MAXSAT; k++) {
    ...
    Console->setItem(n, j++, new QTableWidgetItem(tstr));
    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(eph[k].A, 'f', 3)));
    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(eph[k].e, 'f', 8)));
    Console->setItem(
        n, j++, new QTableWidgetItem(QString::number(eph[k].i0 * R2D, 'f', 5)));
    Console->setItem(
        n, j++,
        new QTableWidgetItem(QString::number(eph[k].OMG0 * R2D, 'f', 5)));
    Console->setItem(
        n, j++,
        new QTableWidgetItem(QString::number(eph[k].omg * R2D, 'f', 5)));
    Console->setItem(
        n, j++, new QTableWidgetItem(QString::number(eph[k].M0 * R2D, 'f', 5)));
    Console->setItem(
        n, j++,
        new QTableWidgetItem(QString::number(eph[k].deln * R2D, 'E', 4)));
    Console->setItem(
        n, j++,
        new QTableWidgetItem(QString::number(eph[k].OMGd * R2D, 'E', 4)));
    Console->setItem(
        n, j++,
        new QTableWidgetItem(QString::number(eph[k].idot * R2D, 'E', 4)));
    Console->setItem(
        n, j++, new QTableWidgetItem(QString::number(eph[k].f0 * 1E9, 'f', 1)));
    Console->setItem(
        n, j++, new QTableWidgetItem(QString::number(eph[k].f1 * 1E9, 'f', 4)));
    Console->setItem(
        n, j++, new QTableWidgetItem(QString::number(eph[k].f2 * 1E9, 'f', 4)));
    Console->setItem(
        n, j++,
        new QTableWidgetItem(QString::number(eph[k].tgd[0] * 1E9, 'f', 1)));
    Console->setItem(
        n, j++,
        new QTableWidgetItem(QString::number(eph[k].tgd[1] * 1E9, 'f', 1)));
    Console->setItem(
        n, j++,
        new QTableWidgetItem(QString::number(eph[k].tgd[2] * 1E9, 'f', 1)));

    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(eph[k].cuc, 'E', 4)));
    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(eph[k].cus, 'E', 4)));
    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(eph[k].crc, 'E', 4)));
    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(eph[k].crs, 'E', 4)));
    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(eph[k].cic, 'E', 4)));
    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(eph[k].cis, 'E', 4)));
    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(eph[k].code)));
    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(eph[k].flag)));
    n++;
  }
  Console->setRowCount(n);
}
...
void MonitorDialog::SetGnav(void) {
  header.clear();
  header << tr("SAT") << tr("PRN") << tr("Status") << tr("IOD") << tr("Freq")
         << tr("Health") << tr("Age(days)") << tr("Toe") << tr("Tof")
         << tr("X (m)") << tr("Y (m)") << tr("Z (m)") << tr("VX (m/s)")
         << tr("VY (m/s)") << tr("VZ (m/s)") << tr("AX (m/s2)")
         << tr("AY (m/s2)") << tr("AZ (m/s2)") << tr("Tau (ns)")
         << tr("Gamma (ns/s)");

  int i, width[] = {25, 25, 30, 30, 30, 25, 25, 115, 115, 75,
                    75, 75, 70, 70, 70, 65, 65, 65,  60,  60};
...
void MonitorDialog::ShowGnav(void) {
  ...
  for (i = 0, n = 1; i < NSATGLO; i++) {
    ...
    if (geph[i].iode < 0)
      ...
      QString::number(geph[i].iode);
    Console->setItem(i, j++, new QTableWidgetItem(s));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(geph[i].frq)));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(geph[i].svh)));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(geph[i].age)));
    ...
    Console->setItem(i, j++, new QTableWidgetItem(tstr));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(geph[i].pos[0], 'f', 2)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(geph[i].pos[1], 'f', 2)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(geph[i].pos[2], 'f', 2)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(geph[i].vel[0], 'f', 5)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(geph[i].vel[1], 'f', 5)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(geph[i].vel[2], 'f', 5)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(geph[i].acc[0], 'f', 7)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(geph[i].acc[1], 'f', 7)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(geph[i].acc[2], 'f', 7)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(geph[i].taun * 1E9, 'f', 1)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(geph[i].gamn * 1E9, 'f', 4)));
    n++;
  }
}
//---------------------------------------------------------------------------
void MonitorDialog::SetSbsNav(void) {
  header.clear();
  header << tr("SAT") << tr("PRN") << tr("Status") << tr("T0") << tr("Tof")
         << tr("Health") << tr("URA") << tr("X (m)") << tr("Y (m)")
         << tr("Z (m)") << tr("VX (m/s)") << tr("VY (m/s)") << tr("VZ (m/s)")
         << tr("AX (m/s2)") << tr("AY (m/s2)") << tr("AZ (m/s2)")
         << tr("af0 (ns)") << tr("af1 (ns/s)");

  int i, width[] = {25, 25, 30, 115, 115, 30, 30, 75, 75,
                    75, 70, 70, 70,  65,  65, 65, 60, 60};
...
void MonitorDialog::ShowSbsNav(void) {
  ...
  for (int i = 0; i < MAXPRNSBS - MINPRNSBS + 1; i++) {
    ...
    seph[i].pos[0] = seph[i].pos[1] = seph[i].pos[2] = seph[i].vel[0] =
        seph[i].vel[1] = seph[i].vel[2] = seph[i].acc[0] = seph[i].acc[1] =
            seph[i].acc[2] = seph[i].af0 = seph[i].af1 = 0;
  };
  ...
  for (i = 0, n = 0; i < NSATSBS; i++) {
    ...
    Console->setItem(i, j++, new QTableWidgetItem(tstr));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(seph[i].svh, 16)));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(seph[i].sva)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(seph[i].pos[0], 'f', 2)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(seph[i].pos[1], 'f', 2)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(seph[i].pos[2], 'f', 2)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(seph[i].vel[0], 'f', 6)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(seph[i].vel[1], 'f', 6)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(seph[i].vel[2], 'f', 6)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(seph[i].acc[0], 'f', 7)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(seph[i].acc[1], 'f', 7)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(seph[i].acc[2], 'f', 7)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(seph[i].af0 * 1E9, 'f', 1)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(seph[i].af1 * 1E9, 'f', 4)));
    n++;
  }
}
//---------------------------------------------------------------------------
...
void MonitorDialog::ShowIonUtc(void) {
  ...
  time = rtksvr.rtk.sol.time;
  for (i = 0; i < 4; i++)
    utc_gps[i] = rtksvr.nav.utc_gps[i];
  for (i = 0; i < 4; i++)
    utc_glo[i] = rtksvr.nav.utc_glo[i];
  for (i = 0; i < 4; i++)
    utc_gal[i] = rtksvr.nav.utc_gal[i];
  for (i = 0; i < 4; i++)
    utc_qzs[i] = rtksvr.nav.utc_qzs[i];
  for (i = 0; i < 8; i++)
    ion_gps[i] = rtksvr.nav.ion_gps[i];
  for (i = 0; i < 4; i++)
    ion_gal[i] = rtksvr.nav.ion_gal[i];
  for (i = 0; i < 8; i++)
    ion_qzs[i] = rtksvr.nav.ion_qzs[i];
  ...
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(QString("%1,%2").arg(week).arg(tow, 0, 'f', 3)));

  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("Leap Seconds (GPST-UTC) (s)")));
  Console->setItem(i++, 1, new QTableWidgetItem(QString::number(leaps)));

  Console->setItem(
      i, 0, new QTableWidgetItem(tr("GPST-UTC Reference Week/Time (s)")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2")
                                            .arg(utc_gps[3], 0, 'f', 0)
                                            .arg(utc_gps[2], 0, 'f', 0)));
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2")
                                            .arg(utc_gps[0] * 1E9, 0, 'f', 3)
                                            .arg(utc_gps[1] * 1E9, 0, 'f', 6)));

  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("GST-GPS Reference Week/Time (s)")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2")
                                            .arg(utc_gal[3], 0, 'f', 0)
                                            .arg(utc_gal[2], 0, 'f', 0)));
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2")
                                            ...
                                            .arg(utc_gal[1] * 1E9, 0, 'f', 6)));

  Console->setItem(
      i, 0, new QTableWidgetItem(tr("QZST-GPS Reference Week/Time (s)")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2")
                                            .arg(utc_qzs[3], 0, 'f', 0)
                                            .arg(utc_qzs[2], 0, 'f', 0)));
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2")
                                            ...
                                            .arg(utc_qzs[1] * 1E9, 0, 'f', 6)));

  Console->setItem(
      i, 0, new QTableWidgetItem(tr("GPS Iono Parameters Alpha0-Alpha3")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3,%4")
                                            .arg(ion_gps[0], 0, 'E', 5)
                                            .arg(ion_gps[1], 0, 'E', 5)
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("GPS Iono Parameters Beta0-Beta3")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3,%4")
                                            .arg(ion_gps[4], 0, 'E', 5)
                                            .arg(ion_gps[5], 0, 'E', 5)
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("GALILEO Iono Parameters 0-2")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(ion_gal[0], 0, 'E', 5)
                                            .arg(ion_gal[1], 0, 'E', 5)
  ...
  Console->setItem(
      i, 0, new QTableWidgetItem(tr("QZS Iono Parameters Alpha0-Alpha3")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3,%4")
                                            .arg(ion_qzs[0], 0, 'E', 5)
                                            .arg(ion_qzs[1], 0, 'E', 5)
  ...
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("QZS Iono Parameters Beta0-Beta3")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3,%4")
                                            .arg(ion_qzs[4], 0, 'E', 5)
                                            .arg(ion_qzs[5], 0, 'E', 5)
...
void MonitorDialog::SetStr(void) {
  header.clear();
  header << tr("Stream") << tr("Type") << tr("Format") << tr("Mode")
         << tr("State") << tr("Input (bytes)") << tr("Input (bps)")
         << tr("Output (bytes)") << tr("Output (bps)") << tr("Path")
         << tr("Message");
...
void MonitorDialog::ShowStr(void) {
  QString ch[] = {
      tr("Input Rover"),       tr("Input Base/NRTK"),   tr("Input Ephemeris"),
      tr("Output Solution 1"), tr("Output Solution 2"), tr("Log Rover"),
      tr("Log Base/NRTK"),     tr("Log Ephemeris"),     tr("Monitor Port")};
  QString type[] = {
      tr("-"),          tr("Serial"), tr("File"),         tr("TCP Server"),
      tr("TCP Client"), tr("UDP"),    tr("NTRIP Server"), tr("NTRIP Client")};
  QString outformat[] = {tr("Lat/Lon/Height"), tr("X/Y/Z-ECEF"),
                         tr("E/N/U-Baseline"), tr("NMEA-0183")};
  ...
  rtksvrlock(&rtksvr); // lock
  for (i = 0; i < 8; i++)
    stream[i] = rtksvr.stream[i];
  for (i = 0; i < 3; i++)
    format[i] = rtksvr.format[i];
  for (i = 3; i < 5; i++)
    format[i] = rtksvr.solopt[i - 3].posf;
  stream[8] = monistr;
  format[8] = SOLF_LLH;
  rtksvrunlock(&rtksvr); // unlock
  ...
  for (i = 0; i < 9; i++) {
    ...
    if (stream[i].mode & STR_MODE_R)
      ...
      mode = "";
    if (stream[i].mode & STR_MODE_W)
      mode = mode + (mode == "" ? "" : "/") + tr("W");
    Console->setItem(i, j++, new QTableWidgetItem(mode));
    Console->setItem(i, j++, new QTableWidgetItem(state[stream[i].state + 1]));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(stream[i].inb)));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(stream[i].inr)));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(stream[i].outb)));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(stream[i].outr)));
...
void MonitorDialog::SetSbsMsg(void) {
  header.clear();
  header << tr("Trcv") << tr("PRN") << tr("Type") << tr("Message")
         << tr("Contents");
...
void MonitorDialog::ShowSbsMsg(void) {
  ...
  QString content[] = {
      ...
      tr("Long Term Satellite Error Corrections",
      ...
      tr("Null Message"),
      ""};
  const int id[] = {0,  1,  2,  3,  4,  5,  6,  7,  9,  10, 12,
                    17, 18, 24, 25, 26, 27, 28, 62, 63, -1};
  char str[64];
  QString s;
  int i, k, n;
  ...
  for (i = 0; i < n; i++) {
    ...
    for (k = 0; k < 29; k++)
      s += QString::number(msg[i].msg[k], 16);
    Console->setItem(i, j++, new QTableWidgetItem(s));
    for (k = 0; id[k] >= 0; k++)
      if (type == id[k])
        break;
    Console->setItem(i, j++,
                     new QTableWidgetItem(id[k] < 0 ? "?" : content[k]));
  }
}
//---------------------------------------------------------------------------
void MonitorDialog::SetSbsLong(void) {
  header.clear();
  header << tr("SAT") << tr("Status") << tr("IODE") << tr("dX (m)")
         << tr("dY (m)") << tr("dZ (m)") << tr("dVX (m/s)") << tr("dVY (m/s)")
         << tr("dVZ (m/s)") << tr("daf0 (ns)") << tr("daf1 (ns/s)") << tr("T0");
...
void MonitorDialog::ShowSbsLong(void) {
  ...
  for (i = 0; i < Console->rowCount(); i++) {
    ...
    bool valid =
        timediff(time, satp->lcorr.t0) <= MAXSBSAGEL && satp->lcorr.t0.time;
    satno2id(satp->sat, id);
    Console->setItem(i, j++, new QTableWidgetItem(id));
    Console->setItem(i, j++, new QTableWidgetItem(valid ? tr("OK") : tr("-")));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(satp->lcorr.iode)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(satp->lcorr.dpos[0], 'f', 3)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(satp->lcorr.dpos[1], 'f', 3)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(satp->lcorr.dpos[2], 'f', 3)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(satp->lcorr.dvel[0], 'f', 4)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(satp->lcorr.dvel[1], 'f', 4)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(satp->lcorr.dvel[2], 'f', 4)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(satp->lcorr.daf0 * 1E9, 'f', 4)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(satp->lcorr.daf1 * 1E9, 'f', 4)));
...
void MonitorDialog::SetSbsIono(void) {
  header.clear();
  header << tr("IODI") << tr("Lat (deg)") << tr("Lon (deg)") << tr("GIVEI")
         << tr("Delay (m)") << tr("T0");
...
void MonitorDialog::ShowSbsIono(void) {
  ...
  for (i = 0; i < MAXBAND; i++) {
    ...
    for (j = 0; j < ion->nigp; j++) {
      k = 0;
      Console->setItem(n, k++,
                       new QTableWidgetItem(QString::number(ion->iodi)));
      Console->setItem(n, k++,
                       new QTableWidgetItem(QString::number(ion->igp[j].lat)));
      Console->setItem(n, k++,
                       new QTableWidgetItem(QString::number(ion->igp[j].lon)));
      Console->setItem(
          n, k++,
          new QTableWidgetItem(
              ion->igp[j].give ? QString::number(ion->igp[j].give - 1) : s0));
      Console->setItem(
          n, k++,
          new QTableWidgetItem(QString::number(ion->igp[j].delay, 'f', 3)));
...
void MonitorDialog::SetSbsFast(void) {
  header.clear();
  header << tr("SAT") << tr("Status") << tr("PRC (m)") << tr("RRC (m)")
         << tr("IODF") << tr("UDREI") << tr("AI") << tr("Tof");
...
void MonitorDialog::ShowSbsFast(void) {
  ...
  for (i = 0; i < Console->rowCount(); i++) {
    int j = 0;
    sbssatp_t *satp = sbssat.sat + i;
    bool valid = fabs(timediff(time, satp->fcorr.t0)) <= MAXSBSAGEF &&
                 satp->fcorr.t0.time && 0 <= satp->fcorr.udre - 1 &&
                 satp->fcorr.udre - 1 < 14;
    satno2id(satp->sat, id);
    Console->setItem(i, j++, new QTableWidgetItem(id));
    Console->setItem(i, j++, new QTableWidgetItem(valid ? tr("OK") : tr("-")));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(satp->fcorr.prc, 'f', 3)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(satp->fcorr.rrc, 'f', 4)));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(satp->fcorr.iodf)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(
            satp->fcorr.udre ? QString::number(satp->fcorr.udre - 1) : s0));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(satp->fcorr.ai)));
...
void MonitorDialog::ShowRtcm(void) {
  ...
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(format == STRFMT_RTCM2 ? tr("RTCM2") : tr("RTCM3")));
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(rtcm.sta.pos[0], 0, 'f', 3)
                                            .arg(rtcm.sta.pos[1], 0, 'f', 3)
                                            .arg(rtcm.sta.pos[2], 0, 'f', 3)));

  if (norm(rtcm.sta.pos, 3) > 0.0)
    ecef2pos(rtcm.sta.pos, pos);
  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("Station Lat/Lon/Height (deg,m)")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(pos[0] * R2D, 0, 'f', 8)
                                            .arg(pos[1] * R2D, 0, 'f', 8)
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString::number(rtcm.sta.itrf)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Antenna Delta Type")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(rtcm.sta.deltype ? tr("X/Y/Z") : tr("E/N/U")));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Antenna Delta (m)")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString("%1,%2,%3")
                                            .arg(rtcm.sta.del[0], 0, 'f', 3)
                                            .arg(rtcm.sta.del[1], 0, 'f', 3)
                                            .arg(rtcm.sta.del[2], 0, 'f', 3)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Antenna Height (m)")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString::number(rtcm.sta.hgt, 'f', 3)));
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString::number(rtcm.sta.antsetup)));
  ...
  Console->setItem(
      i++, 1, new QTableWidgetItem(format == STRFMT_RTCM2 ? mstr1 : mstr2));
...
void MonitorDialog::ShowRtcmDgps(void) {
  ...
  for (i = 1; i < Console->rowCount(); i++) {
    ...
    Console->setItem(i - 1, j++,
                     new QTableWidgetItem(valid ? tr("OK") : tr("-")));
    Console->setItem(
        i - 1, j++, new QTableWidgetItem(QString::number(dgps[i].prc, 'f', 3)));
    Console->setItem(
        i - 1, j++, new QTableWidgetItem(QString::number(dgps[i].rrc, 'f', 4)));
    Console->setItem(i - 1, j++,
                     new QTableWidgetItem(QString::number(dgps[i].iod)));
    Console->setItem(i - 1, j++,
                     new QTableWidgetItem(QString::number(dgps[i].udre)));
    if (dgps[i].t0.time)
...
void MonitorDialog::SetRtcmSsr(void) {
  header.clear();
  header << tr("SAT") << tr("Status") << tr("UDI(s)") << tr("UDHR(s)")
         << tr("IOD") << tr("URA") << tr("Datum") << tr("T0") << tr("D0-A(m)")
         << tr("D0-C(m)") << tr("D0-R(m)") << tr("D1-A(mm/s)")
         << tr("D1-C(mm/s)") << tr("D1-R(mm/s)") << tr("C0(m)")
         << tr("C1(mm/s)") << tr("C2(mm/s2)") << tr("C-HR(m)");
  int i, width[] = {25, 30, 30, 30, 30, 25, 15, 115, 50,
...
void MonitorDialog::ShowRtcmSsr(void) {
  ...
  for (i = 0; i < Console->rowCount(); i++) {
    ...
    Console->setItem(i, j++, new QTableWidgetItem(id));
    bool valid =
        ssr[i].t0[0].time && fabs(timediff(time, ssr[i].t0[0])) <= 1800.0;
    Console->setItem(i, j++, new QTableWidgetItem(valid ? tr("OK") : tr("-")));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(ssr[i].udi[0], 'f', 0)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(ssr[i].udi[2], 'f', 0)));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(ssr[i].iode)));
    Console->setItem(i, j++, new QTableWidgetItem(QString::number(ssr[i].ura)));
    Console->setItem(i, j++,
                     new QTableWidgetItem(QString::number(ssr[i].refd)));
    if (ssr[i].t0[0].time)
    ...
    for (k = 0; k < 3; k++) {
      Console->setItem(
          i, j++,
          new QTableWidgetItem(QString::number(ssr[i].deph[k], 'f', 3)));
    }
    for (k = 0; k < 3; k++) {
      Console->setItem(
          i, j++,
    ...
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(ssr[i].dclk[0], 'f', 3)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(ssr[i].dclk[1] * 1E3, 'f', 3)));
    Console->setItem(
        i, j++,
        new QTableWidgetItem(QString::number(ssr[i].dclk[2] * 1E3, 'f', 5)));
    Console->setItem(
        i, j++, new QTableWidgetItem(QString::number(ssr[i].hrclk, 'f', 3)));
    for (k = 1; k < MAXCODE; k++) {
      Console->setItem(
          i, j++,
          new QTableWidgetItem(QString::number(ssr[i].cbias[k], 'f', 2)));
    }
  }
}
//---------------------------------------------------------------------------
...
void MonitorDialog::ShowLexMsg(void) {
  ...
  if (format == STRFMT_LEXR && raw.time.time)
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString::number(raw.lexmsg.stat)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Signal Tracking Time (s)")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(QString::number(raw.lexmsg.ttt / 1000.0, 'f', 3)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Signal Level (dBHz)")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(QString::number(raw.lexmsg.snr * 0.25, 'f', 1)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("PRN Number")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString::number(raw.lexmsg.prn)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Message Type")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString::number(raw.lexmsg.type)));

  Console->setItem(i, 0, new QTableWidgetItem(tr("Alert Flag")));
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString::number(raw.lexmsg.alert)));

  for (j = 0; j < 7; j++) {
    for (k = 0; k < 32 && j * 32 + k < 212; k++) {
      mstr += QString("%1%2")
                  .arg(raw.lexmsg.msg[j * 32 + k], 16)
                  .arg(k % 4 == 3 ? " " : "");
    }
    Console->setItem(i, 0,
                     new QTableWidgetItem(QString(tr("Data Part (%1-%2)"))
                                              .arg(j * 32 * 8)
                                              .arg((j * 32 + k) * 8 - 1 < 1695
                                                       ? (j * 32 + k) * 8 - 1
                                                       : 1694)));
...
void MonitorDialog::SetLexEph(void) {
  header.clear();
  header << tr("SAT") << tr("Status") << tr("Tof") << tr("Health") << tr("Toe")
         << tr("URA") << tr("PosX(m)") << tr("PosY(m)") << tr("PosZ(m)")
         ...
         << tr("ISCL1C/A(ns)") << tr("ISCL2C(ns)") << tr("ISCL5I(ns)")
         << tr("ISCL5Q(ns)") << tr("ISCL1CP(ns)") << tr("ISCL1CD(ns)")
         << tr("ISCLEX(ns)");
  int i, width[] = {25, 30, 115, 35, 115, 25, 80, 80, 80, 80, 80, 80, 80, 80,
                    80, 80, 80,  80, 60,  50, 50, 50, 50, 50, 50, 50, 50, 50};
...
void MonitorDialog::ShowLexEph(void) {
  ...
  for (i = 0, n = 0; i < MAXSAT; i++) {
    ...
    if (lexeph[i].tof.time == 0)
      sprintf(tstr, "-");
    else
      time2str(lexeph[i].tof, tstr, 0);
    Console->setItem(n, j++, new QTableWidgetItem(tstr));
    ...
    if (lexeph[i].toe.time == 0)
      sprintf(tstr, "-");
    else
      time2str(lexeph[i].toe, tstr, 0);
    Console->setItem(n, j++, new QTableWidgetItem(tstr));

    Console->setItem(n, j++,
                     new QTableWidgetItem(QString::number(lexeph[i].ura)));

    for (k = 0; k < 3; k++) {
      Console->setItem(
          n, j++,
          new QTableWidgetItem(QString::number(lexeph[i].pos[k], 'f', 3)));
    }
    for (k = 0; k < 3; k++) {
      Console->setItem(
          n, j++,
          new QTableWidgetItem(QString::number(lexeph[i].vel[k], 'f', 6)));
    }
    for (k = 0; k < 3; k++) {
      Console->setItem(
          n, j++,
          new QTableWidgetItem(QString::number(lexeph[i].acc[k], 'E', 6)));
    }
    for (k = 0; k < 3; k++) {
      Console->setItem(
          n, j++,
          new QTableWidgetItem(QString::number(lexeph[i].jerk[k], 'E', 6)));
    }
    Console->setItem(
        n, j++,
        new QTableWidgetItem(QString::number(lexeph[i].af0 * 1E9, 'f', 1)));
    Console->setItem(
        n, j++,
        new QTableWidgetItem(QString::number(lexeph[i].af1 * 1E9, 'f', 4)));
    Console->setItem(
        n, j++,
        new QTableWidgetItem(QString::number(lexeph[i].tgd * 1E9, 'f', 1)));
    for (k = 0; k < 7; k++) {
      Console->setItem(n, j++,
                       new QTableWidgetItem(
                           QString::number(lexeph[i].isc[k] * 1E9, 'f', 1)));
    }
    n++;
  }
  Console->setRowCount(n);
...
void MonitorDialog::ShowLexIon(void) {
  ...
  Console->setItem(i++, 1,
                   new QTableWidgetItem(QString::number(lexion.tspan, 'f', 1)));

  Console->setItem(
      i, 0,
      new QTableWidgetItem(tr("Origin of Approx Function Lat/Lon (deg)")));
  Console->setItem(
      i++, 1,
      new QTableWidgetItem(QString("%1 %2")
                               .arg(lexion.pos0[0] * R2D, 0, 'f', 4)
                               .arg(lexion.pos0[1] * R2D, 0, 'f', 4)));

  Console->setItem(i, 0,
                   new QTableWidgetItem(tr("0-0 Degree Coefficient E00 (m)")));
  Console->setItem(
      i++, 1, new QTableWidgetItem(QString::number(lexion.coef[0][0], 'f', 3)));

  Console->setItem(
      i, 0, new QTableWidgetItem(tr("1-1 Degree Coefficient E10 (m/rad)")));
  Console->setItem(
      i++, 1, new QTableWidgetItem(QString::number(lexion.coef[1][0], 'f', 3)));

  Console->setItem(
      i, 0, new QTableWidgetItem(tr("2-0 Degree Coefficient E20 (m/rad^2)")));
  Console->setItem(
      i++, 1, new QTableWidgetItem(QString::number(lexion.coef[2][0], 'f', 3)));

  Console->setItem(
      i, 0, new QTableWidgetItem(tr("0-1 Degree Coefficient E01 (m/rad)")));
  Console->setItem(
      i++, 1, new QTableWidgetItem(QString::number(lexion.coef[0][1], 'f', 3)));

  Console->setItem(
      i, 0, new QTableWidgetItem(tr("1-1 Degree Coefficient E11 (m/rad^2)")));
  Console->setItem(
      i++, 1, new QTableWidgetItem(QString::number(lexion.coef[1][1], 'f', 3)));

  Console->setItem(
      i, 0, new QTableWidgetItem(tr("2-1 Degree Coefficient E21 (m/rad^3)")));
  Console->setItem(
      i++, 1, new QTableWidgetItem(QString::number(lexion.coef[2][1], 'f', 3)));
}
//---------------------------------------------------------------------------
void MonitorDialog::SetIonCorr(void) {
  ...
  for (i = 0; i < Console->columnCount(); i++) {
    Console->setColumnWidth(i, 40 * FontScale / 96);
    Console->setItem(0, i,
                     new QTableWidgetItem(QString("%1E").arg(
                         IONLON1 + (i - 1) * DIONLON, 0, 'f', 0)));
  }
  for (j = 0; j < Console->rowCount(); j++) {
    Console->setItem(j, 0,
                     new QTableWidgetItem(QString("%1N").arg(
                         IONLAT1 - (j - 1) * DIONLAT, 0, 'f', 0)));
  }
  for (i = 0; i < Console->columnCount(); i++)
    for (j = 0; j < Console->rowCount(); j++)
...
void MonitorDialog::ShowIonCorr(void) {
  ...
  time = rtksvr.rtk.sol.time;
  for (i = 0; i < 8; i++)
    nav.ion_gps[i] = rtksvr.nav.ion_gps[i];
  for (i = 0; i < 4; i++)
    nav.ion_gal[i] = rtksvr.nav.ion_gal[i];
  for (i = 0; i < 8; i++)
    nav.ion_qzs[i] = rtksvr.nav.ion_qzs[i];
  for (i = 0; i < MAXBAND + 1; i++)
    nav.sbsion[i] = rtksvr.nav.sbsion[i];
  ...
  for (i = 0; i < Console->columnCount(); i++)
    for (j = 0; j < Console->rowCount(); j++) {
      ...
      if (!ionocorr(time, &nav, 0, pos, azel, ionoopt, &ion, &var) ||
          ion == 0.0) {
        Console->setItem(j, i, new QTableWidgetItem("-"));
      } else {
        Console->setItem(j, i,
                         new QTableWidgetItem(QString::number(ion, 'f', 2)));
      }
    }
}
//---------------------------------------------------------------------------
