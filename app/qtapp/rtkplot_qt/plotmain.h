...
private:
  ...
  void DrawTrkPos(QPainter &g, const double *rr, int type, int siz,
                  QColor color, const QString &label);
  void DrawTrkStat(QPainter &g, const TIMEPOS *pos, const QString &header,
                   int p);
  ...
  void DrawLabel(Graph *, QPainter &g, const QPoint &p, const QString &label,
                 int ha, int va);
  void DrawMark(Graph *, QPainter &g, const QPoint &p, int mark,
  ...
  void CalcStats(const double *x, int n, double ref, double &ave, double &std,
                 double &rms);
