...
PlotOptDialog::PlotOptDialog(QWidget *parent) : QDialog(parent) {
  ...
  connect(BtnTLESatView, SIGNAL(clicked(bool)), this,
          SLOT(BtnTLESatViewClick()));
  ...
  connect(AutoScale, SIGNAL(currentIndexChanged(int)), this,
          SLOT(AutoScaleChange()));
...
void PlotOptDialog::showEvent(QShowEvent *event) {
  ...
  MColor1->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[0][1])));
  MColor2->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[0][2])));
  MColor3->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[0][3])));
  MColor4->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[0][4])));
  MColor5->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[0][5])));
  MColor6->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[0][6])));
  MColor7->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[1][1])));
  MColor8->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[1][2])));
  MColor9->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[1][3])));
  MColor10->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[1][4])));
  MColor11->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[1][5])));
  MColor12->setStyleSheet(
      QString("background-color: %1;").arg(color2String(plot->MColor[1][6])));
  Color1->setStyleSheet(QString("QLabel {background-color: %1;}")
                            .arg(color2String(plot->CColor[0])));
  Color2->setStyleSheet(QString("QLabel {background-color: %1;}")
                            .arg(color2String(plot->CColor[1])));
  Color3->setStyleSheet(QString("QLabel {background-color: %1;}")
                            .arg(color2String(plot->CColor[2])));
  Color4->setStyleSheet(QString("QLabel {background-color: %1;}")
                            .arg(color2String(plot->CColor[3])));
...
void PlotOptDialog::MColorClick() {
  ...
  button->setStyleSheet(
      QString("background-color: %1").arg(color2String(dialog.currentColor())));
...
void PlotOptDialog::BtnColor1Click() {
  ...
  if (dialog.result() != QDialog::Accepted)
    return;
  Color1->setStyleSheet(QString("QLabel {background-color: %1;}")
                            .arg(color2String(dialog.currentColor())));
...
void PlotOptDialog::BtnQcCmdClick() {
  QcCmd->setText(
      QDir::toNativeSeparators(QFileDialog::getOpenFileName(this, tr("Open"))));
}
//---------------------------------------------------------------------------
...
void PlotOptDialog::BtnRefPosClick() {
  ...
  refDialog->move(
      pos().x() + size().width() / 2 - refDialog->size().width() / 2,
...
void PlotOptDialog::UpdateFont(void) {
  ...
  FontLabel->setText(FontOpt.family() + " " +
                     QString::number(FontOpt.pointSize()) + " pt");
}
//---------------------------------------------------------------------------
void PlotOptDialog::UpdateEnable(void) {
  RefPos1->setEnabled(Origin->currentIndex() == 5 ||
                      RcvPos->currentIndex() == 1);
  RefPos2->setEnabled(Origin->currentIndex() == 5 ||
                      RcvPos->currentIndex() == 1);
  RefPos3->setEnabled(Origin->currentIndex() == 5 ||
                      RcvPos->currentIndex() == 1);
  LabelRefPos->setEnabled(Origin->currentIndex() == 5 ||
                          Origin->currentIndex() == 6 ||
                          RcvPos->currentIndex() == 1);
  BtnRefPos->setEnabled(Origin->currentIndex() == 5 ||
                        Origin->currentIndex() == 6 ||
                        RcvPos->currentIndex() == 1);
}
//---------------------------------------------------------------------------
