...
void VecMapDialog::BtnColor1Click() {
  ...
  Color1->setStyleSheet(QString("QFrame {background-color: %1;}")
...
void VecMapDialog::BtnColor2Click() {
  ...
  Color2->setStyleSheet(QString("QFrame {background-color: %1;}")
                            .arg(color2String(dialog.currentColor())));
...
void VecMapDialog::BtnColor3Click() {
  ...
  Color3->setStyleSheet(QString("QFrame {background-color: %1;}")
                            .arg(color2String(dialog.currentColor())));
...
void VecMapDialog::BtnColor4Click() {
  ...
  Color4->setStyleSheet(QString("QFrame {background-color: %1;}")
                            .arg(color2String(dialog.currentColor())));
...
void VecMapDialog::BtnColor5Click() {
  ...
  Color5->setStyleSheet(QString("QFrame {background-color: %1;}")
                            .arg(color2String(dialog.currentColor())));
...
void VecMapDialog::BtnColor6Click() {
  ...
  Color6->setStyleSheet(QString("QFrame {background-color: %1;}")
                            .arg(color2String(dialog.currentColor())));
...
void VecMapDialog::BtnColor7Click() {
  ...
  Color7->setStyleSheet(QString("QFrame {background-color: %1;}")
                            .arg(color2String(dialog.currentColor())));
...
void VecMapDialog::BtnColor8Click() {
  ...
  Color8->setStyleSheet(QString("QFrame {background-color: %1;}")
                            .arg(color2String(dialog.currentColor())));
...
void VecMapDialog::BtnColor9Click() {
  ...
  Color9->setStyleSheet(QString("QFrame {background-color: %1;}")
                            .arg(color2String(dialog.currentColor())));
...
void VecMapDialog::BtnColor10Click() {
  ...
  Color10->setStyleSheet(QString("QFrame {background-color: %1;}")
                             .arg(color2String(dialog.currentColor())));
...
void VecMapDialog::BtnColor11Click() {
  ...
  Color11->setStyleSheet(QString("QFrame {background-color: %1;}")
                             .arg(color2String(dialog.currentColor())));
...
void VecMapDialog::BtnColor12Click() {
  ...
  Color12->setStyleSheet(QString("QFrame {background-color: %1;}")
                             .arg(color2String(dialog.currentColor())));
...
void VecMapDialog::BtnUpClick() {
  QRadioButton *layer[] = {Layer1, Layer2, Layer3, Layer4,  Layer5,  Layer6,
                           Layer7, Layer8, Layer9, Layer10, Layer11, Layer12};
  QFrame *color[] = {Color1, Color2, Color3, Color4,  Color5,  Color6,
...
void VecMapDialog::VisClick() {
  QCheckBox *vis[] = {Vis1, Vis2, Vis3, Vis4,  Vis5,  Vis6,
                      Vis7, Vis8, Vis9, Vis10, Vis11, Vis12};
  for (int i = 0; i < MAXMAPLAYER; i++) {
...
void VecMapDialog::showEvent(QShowEvent *event) {
  ...
  for (int i = 0; i < MAXMAPLAYER; i++) {
    layer[i]->setChecked(false);
    color[i]->setStyleSheet(QString("QFrame {background-color: %1;}")
                                .arg(color2String(plot->MapColor[i])));
  }
  UpdateLayer();
}
//---------------------------------------------------------------------------
