...
private:
  ...
  void __fastcall DrawSnr(TCanvas *c, int w, int h, int x0, int y0, int index,
                          int freq);
  void __fastcall DrawSat(TCanvas *c, int w, int h, int x0, int y0, int index,
                          int freq);
  ...
  void __fastcall DrawText(TCanvas *c, int x, int y, UTF8String s, TColor color,
                           int ha, int va);
  void __fastcall DrawArrow(TCanvas *c, int x, int y, int siz, int ang,
                            TColor color);
