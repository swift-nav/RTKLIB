...
//---------------------------------------------------------------------------
__fastcall TConnectDialog::TConnectDialog(TComponent *Owner) : TForm(Owner) {
...
void __fastcall TConnectDialog::FormShow(TObject *Sender) {
  ...
  for (int i = 0; i < 6; i++) {
    if (str[i] == Stream1)
      SelStream1->ItemIndex = i;
    if (str[i] == Stream2)
      SelStream2->ItemIndex = i;
  }
...
void __fastcall TConnectDialog::UpdateEnable(void) {
  ...
  Label8->Enabled =
      (2 <= SelStream1->ItemIndex && SelStream1->ItemIndex <= 4) ||
      (2 <= SelStream2->ItemIndex && SelStream2->ItemIndex <= 4);
  TimeOutTimeE->Enabled =
      (2 <= SelStream1->ItemIndex && SelStream1->ItemIndex <= 4) ||
      (2 <= SelStream2->ItemIndex && SelStream2->ItemIndex <= 4);
  ReConnTimeE->Enabled =
      (2 <= SelStream1->ItemIndex && SelStream1->ItemIndex <= 4) ||
