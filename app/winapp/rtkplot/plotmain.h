...
class TPlot : public TForm {
  ...
  void __fastcall DispGesture(TObject *Sender,
...
private:
  ...
  void __fastcall MouseMoveTrk(int X, int Y, double dx, double dy, double dxs,
                               double dys);
  void __fastcall MouseMoveSol(int X, int Y, double dx, double dy, double dxs,
                               double dys);
  void __fastcall MouseMoveObs(int X, int Y, double dx, double dy, double dxs,
                               double dys);
  ...
  void __fastcall DrawTrkPos(const double *rr, int type, int siz, TColor color,
                             UTF8String label);
  ...
  void __fastcall DrawLabel(TGraph *g, TPoint p, UTF8String label, int ha,
                            int va);
  void __fastcall DrawMark(TGraph *g, TPoint p, int mark, TColor color,
                           int size, int rot);
  ...
  void __fastcall PosToXyz(gtime_t time, const double *rr, int type,
                           double *xyz);
