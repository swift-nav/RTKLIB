...
//---------------------------------------------------------------------------
__fastcall TVecMapDialog::TVecMapDialog(TComponent *Owner) : TForm(Owner) {}
//---------------------------------------------------------------------------
void __fastcall TVecMapDialog::Layer1Click(TObject *Sender) {
  TRadioButton *layer[] = {Layer1, Layer2, Layer3, Layer4,  Layer5,  Layer6,
...
void __fastcall TVecMapDialog::BtnUpClick(TObject *Sender) {
  TRadioButton *layer[] = {Layer1, Layer2, Layer3, Layer4,  Layer5,  Layer6,
                           Layer7, Layer8, Layer9, Layer10, Layer11, Layer12};
  TPanel *color[] = {Color1, Color2, Color3, Color4,  Color5,  Color6,
                     Color7, Color8, Color9, Color10, Color11, Color12};
  TPanel *colorf[] = {Color1F, Color2F, Color3F, Color4F,  Color5F,  Color6F,
...
void __fastcall TVecMapDialog::Vis1Click(TObject *Sender) {
  TCheckBox *vis[] = {Vis1, Vis2, Vis3, Vis4,  Vis5,  Vis6,
                      Vis7, Vis8, Vis9, Vis10, Vis11, Vis12};
  for (int i = 0; i < MAXMAPLAYER; i++) {
    if ((TCheckBox *)Sender == vis[i])
      Gis.flag[i] = vis[i]->Checked ? 1 : 0;
  }
  UpdateMap();
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TVecMapDialog::BtnApplyClick(TObject *Sender) { UpdateMap(); }
//---------------------------------------------------------------------------
void __fastcall TVecMapDialog::BtnCloseClick(TObject *Sender) { Close(); }
//---------------------------------------------------------------------------
void __fastcall TVecMapDialog::ColorClick(TObject *Sender) {
  TPanel *color[] = {Color1,  Color2,   Color3,   Color4,   Color5,
                     Color6,  Color7,   Color8,   Color9,   Color10,
                     Color11, Color12,  Color1F,  Color2F,  Color3F,
                     Color4F, Color5F,  Color6F,  Color7F,  Color8F,
                     Color9F, Color10F, Color11F, Color12F, NULL};
  int i;

  for (i = 0; color[i]; i++) {
    if (color[i] == (TPanel *)Sender)
      break;
  }
  if (color[i]) {
