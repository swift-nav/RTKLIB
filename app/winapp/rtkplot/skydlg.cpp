...
void __fastcall TSkyImgDialog::BtnSaveClick(TObject *Sender) {
  ...
  fprintf(fp, "dest    = %.6g %.6g %.6g %.6g %.6g %.6g %.6g %.6g %.6g\n",
          Plot->SkyDest[1], Plot->SkyDest[2], Plot->SkyDest[3],
          Plot->SkyDest[4], Plot->SkyDest[5], Plot->SkyDest[6],
...
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::SkyFov2UpDownChangingEx(
    TObject *Sender, bool &AllowChange, int NewValue,
...
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::SkyFov1UpDownChangingEx(
    TObject *Sender, bool &AllowChange, int NewValue,
    TUpDownDirection Direction) {
  AnsiString s;
...
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::SkyFov3UpDownChangingEx(
    TObject *Sender, bool &AllowChange, int NewValue,
    TUpDownDirection Direction) {
  AnsiString s;
...
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::SkyCent1UpDownChangingEx(
    TObject *Sender, bool &AllowChange, int NewValue,
    TUpDownDirection Direction) {
  AnsiString s;
...
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::SkyCent2UpDownChangingEx(
    TObject *Sender, bool &AllowChange, int NewValue,
    TUpDownDirection Direction) {
  AnsiString s;
...
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::SkyScaleUpDownChangingEx(
    TObject *Sender, bool &AllowChange, int NewValue,
    TUpDownDirection Direction) {
  AnsiString s;
...
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::SkyElMaskMouseUp(TObject *Sender,
                                                TMouseButton Button,
...
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::SkyDestCorrMouseUp(TObject *Sender,
                                                  TMouseButton Button,
                                                  TShiftState Shift, int X,
                                                  int Y) {
  UpdateSky();
...
//---------------------------------------------------------------------------
void __fastcall TSkyImgDialog::SkyFlipMouseUp(TObject *Sender,
                                              TMouseButton Button,
...
void __fastcall TSkyImgDialog::BtnGenMaskClick(TObject *Sender) {
  ...
  if (!GetObject(Plot->SkyImageR->Handle, sizeof(bm), &bm))
    return;
  w = bm.bmWidth;
  h = bm.bmHeight;
  b = bm.bmWidthBytes;
...
void __fastcall TSkyImgDialog::SkyBinThres1UpDownChangingEx(
...
void __fastcall TSkyImgDialog::SkyBinThres2UpDownChangingEx(
    TObject *Sender, bool &AllowChange, short NewValue,
    TUpDownDirection Direction) {
  AnsiString s;
...
void __fastcall TSkyImgDialog::SkyBinarizeMouseUp(TObject *Sender,
                                                  TMouseButton Button,
                                                  TShiftState Shift, int X,
                                                  int Y) {
  UpdateSky();
