...
public:
  ...
  void DrawCircle(double x, double y, TColor color, double rx, double ry,
                  int style);
  ...
  void DrawText(TPoint p, UTF8String str, TColor color, int ha, int va,
                int rot);
  void DrawText(TPoint p, UTF8String str, TColor color, int ha, int va, int rot,
                AnsiString font);
  void DrawText(double x, double y, UTF8String str, TColor color,
                TColor bgcolor, int ha, int va, int rot);
  void DrawText(TPoint p, UTF8String str, TColor color, TColor bgcolor, int ha,
                int va, int rot);
  ...
  void DrawPatch(double *x, double *y, int n, TColor color1, TColor color2,
                 int style);
  void DrawSkyPlot(TPoint p, TColor color1, TColor color2, int size);
  void DrawSkyPlot(double x, double y, TColor color1, TColor color2,
                   double size);
  void DrawSkyPlot(TPoint p, TColor color1, TColor color2, TColor bgcolor,
                   int size);
  void DrawSkyPlot(double x, double y, TColor color1, TColor color2,
