...
//---------------------------------------------------------------------------
__fastcall TSpanDialog::TSpanDialog(TComponent *Owner) : TForm(Owner) {
  for (int i = 0; i < 3; i++) {
    TimeEna[i] = true;
    TimeVal[i] = true;
  }
...
void __fastcall TSpanDialog::FormShow(TObject *Sender) {
  ...
  time2str(TimeStart, ts, 0);
  ts[10] = '\0';
  time2str(TimeEnd, te, 0);
  te[10] = '\0';
  TimeY1->Text = ts;
  TimeH1->Text = ts + 11;
  TimeY2->Text = te;
...
//---------------------------------------------------------------------------
void __fastcall TSpanDialog::TimeEndFClick(TObject *Sender) { UpdateEnable(); }
//---------------------------------------------------------------------------
void __fastcall TSpanDialog::TimeIntFClick(TObject *Sender) { UpdateEnable(); }
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TSpanDialog::TimeY1KeyDown(TObject *Sender, WORD &Key,
                                           TShiftState Shift)
...
//---------------------------------------------------------------------------
void __fastcall TSpanDialog::TimeH1KeyDown(TObject *Sender, WORD &Key,
                                           TShiftState Shift)
...
//---------------------------------------------------------------------------
void __fastcall TSpanDialog::TimeY2KeyDown(TObject *Sender, WORD &Key,
                                           TShiftState Shift)
...
//---------------------------------------------------------------------------
void __fastcall TSpanDialog::TimeH2KeyDown(TObject *Sender, WORD &Key,
                                           TShiftState Shift)
