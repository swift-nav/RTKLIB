...
void __fastcall TMainForm::BtnNtripClick(TObject *Sender) {
  UnicodeString cmd1 = "srctblbrows", cmd2 = "..\\..\\..\\bin\\srctblbrows",
                opts = "";
...
void __fastcall TMainForm::Panel1Resize(TObject *Sender) {
  TSpeedButton *btn[] = {BtnPlot,  BtnConv, BtnStr, BtnPost,
                         BtnNtrip, BtnNavi, BtnGet};
  int i, j, k, n, m, h;
...
//---------------------------------------------------------------------------
void __fastcall TMainForm::BtnRtklibMouseDown(TObject *Sender,
                                              TMouseButton Button,
